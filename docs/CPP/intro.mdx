...
[Link da documentação da Microsoft](https://learn.microsoft.com/en-us/cpp/standard-library/cpp-standard-library-header-files?view=msvc-170)

[Link da documentação da comunidade](https://en.cppreference.com/w/)
