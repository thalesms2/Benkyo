...
int main (){
	...
	char m1[TAM][TAM*5] = {char(255)}, m2[TAM][TAM*5] = {char(255)}, m3[TAM][TAM*5] = {char(255)}, menu[TAM][TAM*5] = {char(255)}, tecla;
	...
	/// MAPA 1
	// PAREDES
	m1[3][4] = m1[3][5] = m1[3][6] = m1[3][7] = m1[3][8] = m1[3][9] = m1[3][10] = m1[3][11] = m1[4][3] = m1[4][4] = m1[4][7] = m1[4][10] = m1[4][11] = m1[4][12] = m1[5][3] = m1[5][4] = m1[5][7] = m1[5][12] = m1[5][13] = m1[6][3] = m1[6][13] = m1[7][3] = m1[7][7] = m1[7][8] = m1[7][13] = m1[8][3] = m1[8][4] = m1[8][5] = m1[8][6] = m1[8][7] = m1[8][8] = m1[8][12] = m1[8][13] = m1[9][8] = m1[9][9] = m1[9][10] = m1[9][11] = m1[9][12] = char(219);
	//OBJETIVO
	...
	/// MAPA2
    // PAREDES
    m2[3][6] = m2[3][7] = m2[3][8] = m2[3][9] = m2[3][10] = m2[3][11] = m2[3][12] = m2[4][6] =  m2[4][12] = m2[5][6] = m2[5][12] = m2[6][4] = m2[6][5] = m2[6][6] = m2[6][7] = m2[6][8] = m2[6][10] = m2[6][12] = m2[7][4] = m2[7][12] = m2[8][4] = m2[8][7] = m2[8][9] = m2[8][10] = m2[8][12] = m2[8][13] = m2[9][4] = m2[9][10] = m2[9][13] = m2[10][4] = m2[10][13] = m2[11][4] = m2[11][5] = m2[11][6] = m2[11][7] = m2[11][8] = m2[11][9] = m2[11][10] = m2[11][11] = m2[11][12] = m2[11][13] = char(219);
	// OBJETIVO
	...
	while(endGame == false){
        while(startMenu == true){
            ...
            menu[6][1] = 'W'; menu[6][2] = char(255); menu[6][3] = '='; menu[6][4] = char(255); menu[6][5] = 'U'; menu[6][6] = 'P'; menu[6][7] = char(255); menu[6][8] = '|'; menu[6][9] = char(255); menu[6][10] = 'S'; menu[6][11] = char(255); menu[6][12] = '='; menu[6][13] = char(255); menu[6][14] = 'D'; menu[6][15] = 'O'; menu[6][16] = 'N'; menu[6][17] = 'W'; menu[6][18] = char(255); menu[6][19] = '|'; menu[6][20] = char(255); menu[6][21] = 'D'; menu[6][22] = char(255);  menu[6][23] = '='; menu[6][24] = char(255); menu[6][25] = 'E'; menu[6][26] = 'N'; menu[6][27] = 'T'; menu[6][28] = 'E'; menu[6][29] = 'R';
            /// FIM DADOS DO MENU
            for(i=0;i<TAM;i++){
                for(j=0;j<TAM*5;j++){
                    cout << menu[i][j];
        ...
        while(startHow2Play == true){
            cout << "-------Menu-------\nW = Cima \nS = Baixo  \nD = Selecionar \n";
            cout << "-----No jogo----- \nW = Cima \nS = Baixo \nD = Selecionar \nA = Esquerda \nD = Direita \nR = Reiniciar Mapa \nM = Menu agora sim quer ver que essa porra nao vai aparecer";
            tecla = getch();
            if (tecla != ' '){
                startHow2Play = false;
                startMenu = true;
        ...
        while(startMapa1==true){
            ...
            if (m1[5][5] == char(255)){ /// Rewrite checkpoints
                m1[5][5] = 'X';
            }
            if (m1[5][10] == char(255)){
                m1[5][10] = 'X';
        ...
        while(startMapa2==true){
            ...
            if (m2[9][5] == char(255)){ /// Rewrite checkpoints
                m2[9][5] = 'X';
            }
            if (m2[9][6] == char(255)){
                m2[9][6] = 'X';
        ...
        while(startMapa3==true){
            ...
            if (m3[4][4] == char(255)){ /// Rewrite checkpoints
                m3[4][4] = 'X';
            }
            if (m3[4][5] == char(255)){
                m3[4][5] = 'X';
